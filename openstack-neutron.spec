...
Source50:	neutron-server.service
Source51:	neutron-linuxbridge-agent.service
Source52:	neutron-openvswitch-agent.service
Source53:	neutron-ryu-agent.service
Source54:	neutron-nec-agent.service
Source55:	neutron-dhcp-agent.service
Source56:	neutron-l3-agent.service
Source57:	neutron-metadata-agent.service
Source58:	neutron-ovs-cleanup.service
Source59:	neutron-lbaas-agent.service
Source60:	neutron-mlnx-agent.service
Source61:	neutron-vpn-agent.service
Source62:	neutron-metering-agent.service
Source63:	neutron-sriov-nic-agent.service
Source64:	neutron-cisco-cfg-agent.service
Source65:	neutron-netns-cleanup.service


Source80:	neutron-netns-cleanup.ocf_lib
Source81:	neutron-ovs-cleanup.ocf_lib
Source82:	NetnsCleanup.ocf_ra
Source83:	OVSCleanup.ocf_ra
Source84:	NeutronScale.ocf_ra
...
install -p -D -m 644 %{SOURCE50} %{buildroot}%{_unitdir}/neutron-server.service
install -p -D -m 644 %{SOURCE51} %{buildroot}%{_unitdir}/neutron-linuxbridge-agent.service
install -p -D -m 644 %{SOURCE52} %{buildroot}%{_unitdir}/neutron-openvswitch-agent.service
install -p -D -m 644 %{SOURCE53} %{buildroot}%{_unitdir}/neutron-ryu-agent.service
install -p -D -m 644 %{SOURCE54} %{buildroot}%{_unitdir}/neutron-nec-agent.service
install -p -D -m 644 %{SOURCE55} %{buildroot}%{_unitdir}/neutron-dhcp-agent.service
install -p -D -m 644 %{SOURCE56} %{buildroot}%{_unitdir}/neutron-l3-agent.service
install -p -D -m 644 %{SOURCE57} %{buildroot}%{_unitdir}/neutron-metadata-agent.service
install -p -D -m 644 %{SOURCE58} %{buildroot}%{_unitdir}/neutron-ovs-cleanup.service
install -p -D -m 644 %{SOURCE59} %{buildroot}%{_unitdir}/neutron-lbaas-agent.service
install -p -D -m 644 %{SOURCE60} %{buildroot}%{_unitdir}/neutron-mlnx-agent.service
install -p -D -m 644 %{SOURCE61} %{buildroot}%{_unitdir}/neutron-vpn-agent.service
install -p -D -m 644 %{SOURCE62} %{buildroot}%{_unitdir}/neutron-metering-agent.service
install -p -D -m 644 %{SOURCE63} %{buildroot}%{_unitdir}/neutron-sriov-nic-agent.service
install -p -D -m 644 %{SOURCE64} %{buildroot}%{_unitdir}/neutron-cisco-cfg-agent.service
install -p -D -m 644 %{SOURCE65} %{buildroot}%{_unitdir}/neutron-netns-cleanup.service
%endif

# Install scripts for pacemaker support
install -p -D -m 755 %{SOURCE80} %{buildroot}%{_prefix}/lib/ocf/lib/neutron/neutron-netns-cleanup
install -p -D -m 755 %{SOURCE81} %{buildroot}%{_prefix}/lib/ocf/lib/neutron/neutron-ovs-cleanup
install -p -D -m 755 %{SOURCE82} %{buildroot}%{_prefix}/lib/ocf/resource.d/neutron/NetnsCleanup
install -p -D -m 755 %{SOURCE83} %{buildroot}%{_prefix}/lib/ocf/resource.d/neutron/OVSCleanup
install -p -D -m 755 %{SOURCE84} %{buildroot}%{_prefix}/lib/ocf/resource.d/neutron/NeutronScale
...
%dir %attr(0750, neutron, neutron) %{_localstatedir}/run/neutron
