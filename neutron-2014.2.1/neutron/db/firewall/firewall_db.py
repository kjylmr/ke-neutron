...
from neutron.extensions import firewallrouterinsertion as fw_ext
...
class Firewall_db_mixin(firewall.FirewallPluginBase, base_db.CommonDbMixin):
    ...
    def delete_firewall(self, context, id):
        ...
        with context.session.begin(subtransactions=True):
            ...
            # firewall is active
            #count = context.session.query(Firewall).filter_by(id=id)
    ...
    def validate_firewall_routers_not_in_use(
        ...
        if fw_rtrs:
            ...
            raise fw_ext.FirewallRouterInUse(router_ids=router_ids)
