...
class SecurityGroupRule(model_base.BASEV2, models_v2.HasId,
    ...
    action = sa.Column(sa.Enum('allow', 'deny',
                               name='securitygrouprules_action'), default='allow')
...
#                # Allow special traffic
#                if ethertype == 'IPv4':
#                    # Allow manage traffic
#                    ingress_rule = SecurityGroupRule(
#                        id=uuidutils.generate_uuid(), tenant_id=tenant_id,
#                        security_group=security_group_db,
#                        direction='ingress',
#                        ethertype=ethertype,
#                        remote_ip_prefix='10.121.224.0/24')
#                    context.session.add(ingress_rule)
#
#                    # Allow pass traffic
#                    ingress_rule = SecurityGroupRule(
...
#                        direction='ingress',
#                        ethertype=ethertype,
#                        remote_ip_prefix='10.121.3.32/27')
#                    context.session.add(ingress_rule)
#                    ingress_rule = SecurityGroupRule(
#                        id=uuidutils.generate_uuid(), tenant_id=tenant_id,
#                        security_group=security_group_db,
#                        direction='ingress',
#                        ethertype=ethertype,
#                        remote_ip_prefix='10.121.3.64/27')
#                    context.session.add(ingress_rule)
#                    ingress_rule = SecurityGroupRule(
#                        id=uuidutils.generate_uuid(), tenant_id=tenant_id,
#                        security_group=security_group_db,
#                        direction='ingress',
#                        ethertype=ethertype,
#                        remote_ip_prefix='10.121.3.96/28')
#                    context.session.add(ingress_rule)
    ...
    def _make_security_group_rule_dict(self, security_group_rule, fields=None):
        res = {'id': security_group_rule['id'],
               ...
               'action': security_group_rule['action'],
