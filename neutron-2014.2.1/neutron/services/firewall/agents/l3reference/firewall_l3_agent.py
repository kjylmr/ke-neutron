...
class FWaaSL3AgentRpcCallback(api.FWaaSAgentRpcCallbackMixin):
    ...
    def _get_router_ids_for_fw(self, context, fw, to_delete=False):
        ...
        if self._has_router_insertion_fields(fw):
            ...
            try:
                ...
                LOG.exception(_("FWaaS RPC failure in _get_router_ids_for_fw "
                                "for firewall: %(fwid)s"),
                                {'fwid': fw['id']})
    ...
    def create_firewall(self, context, firewall, host):
        ...
        try:
            ...
            LOG.exception(_("FWaaS RPC failure in create_firewall "
                            "for firewall: %(fwid)s"),
                            {'fwid': firewall['id']})
            self.services_sync = True
    ...
    def update_firewall(self, context, firewall, host):
        ...
        try:
            ...
            LOG.exception(_("FWaaS RPC failure in update_firewall "
                            "for firewall: %(fwid)s"),
                            {'fwid': firewall['id']})
            self.services_sync = True
    ...
    def delete_firewall(self, context, firewall, host):
        ...
        if router_ids:
            ...
            try:
                ...
                LOG.exception(_("FWaaS RPC failure in delete_firewall "
                                "for firewall: %(fwid)s"),
                                {'fwid': firewall['id']})
                self.services_sync = True
